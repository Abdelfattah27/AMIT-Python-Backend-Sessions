...
console.log(yearsUntilRetirement(1991, 'abdelfattah')); console.log(yearsUntilRetirement(1980, 'Bob'));
...
const abdelfattah = [firstName, 'hamdi', 2037 - 1991, 'teacher', friends];
...
console.log(abdelfattah.lastName);
console.log(abdelfattah['lastName']);

const nameKey = 'Name';
console.log(abdelfattah['first' + nameKey]);
console.log(abdelfattah['last' + nameKey]);
...
console.log(abdelfattah.calcAge());

console.log(abdelfattah.age);
console.log(abdelfattah.age);
console.log(abdelfattah.age);
...
// console.log(abdelfattah[0])
// console.log(abdelfattah[1])
// ...
// console.log(abdelfattah[4])
// abdelfattah[5] does NOT exist
